...
for (type in c("fit", "eval"))
{
  ...
  # New folder path
  folder_extracted <- str_glue("{datafolder_path}/Data_Global/Response_variable/Changes_extracted/Single_files_new") 
  ...
  out_folder <- str_glue("{datafolder_path}/Data_Global/Response_variable/Changes_extracted/Combined_files")
