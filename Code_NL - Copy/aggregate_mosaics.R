...
files_list <- str_glue("{datafolder_path}/Data_NL/Model_output" ) %>% 
...
for (file in files_list)
{
  ...
  {   
    for (method in methods)
    {
      ...
      # print(outname)
      basef <- str_glue("{datafolder_path}/Data_NL/Model_output/Aggregated_layers")
      ...
      if (!file.exists(output_name))
      {
        ...
        GDAL_resample2(infile = file, outfile = output_name, target_extent = "3.360782 50.723492  7.227095 53.554584",
