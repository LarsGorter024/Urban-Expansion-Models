...
#   raster()
# 
my_r <-raster("/vol/milkunarc/ES_students/lgorter/Urban_Expansion_model/Data/Data_Global/Cropland/Agri_suitability_aggregated_10m_avg_10.tif")
...
my_plots <- cat_190 / p_legend +
  plot_layout(
    # widths = unit(c(13, 11.3, 14.3), c("cm", "cm", "cm"))
    heights = unit(c(10, 10, 10, 4), c("cm", "cm", "cm", "cm"))
  )
...
ggsave(str_glue("{datafolder_path}/Data_Global/Model_output/Figures/Response_2b.jpg"), my_plots,
       dpi = 300, width = 22, height = 16)
toc()
